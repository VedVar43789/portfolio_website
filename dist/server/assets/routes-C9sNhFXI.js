...
import { ArrowRight, ChevronDown, ChevronsRight, ExternalLink, FileText, Github, GraduationCap, Linkedin, Mail, MapPin, Menu, Moon, Send, Sparkles, Star, Sun, X } from "lucide-react";
...
//#endregion
//#region src/assets/vedant_ds3.jpg
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-cyan animate-pulse" }), "Open to AI / ML Engineering and SWE roles"]
							}),
							/* @__PURE__ */ jsxs("h1", {
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				featuredRoles.length > 0 && /* @__PURE__ */ jsx(Reveal, {
					className: "mb-10",
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(Sparkles, { size: 14 }), /* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: featuredRoles.map(({ e, idx }) => /* @__PURE__ */ jsxs("a", {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("span", { className: "absolute left-2 md:left-auto md:right-[-9px] top-3 h-3 w-3 rounded-full bg-primary shadow-[0_0_0_4px_var(--background)]" }), /* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												e.progression && e.progression.length > 0 && /* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsx("p", {
														...
														children: e.progression.map((step, idx) => /* @__PURE__ */ jsxs("div", {
															className: "contents",
															children: [/* @__PURE__ */ jsxs("div", {
															...
															}), idx < e.progression.length - 1 && /* @__PURE__ */ jsx(ChevronsRight, {
																size: 14,
